...
export function makeObjectPropertyPusher<T>(valueReader: (this: T, p0: Element, p1: any[]) => any, opt_property?: string, opt_this?: T): Parser;
export function makeObjectPropertySetter<T>(valueReader: (this: T, p0: Element, p1: any[]) => any, opt_property?: string, opt_this?: T): Parser;
