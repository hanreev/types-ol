...
export function makeArraySerializer<T, V>(nodeWriter: ((this: T, p0: Element, p1: V, p2: any[]) => void), opt_this?: T): Serializer;
export function makeChildAppender<T, V>(nodeWriter: ((this: T, p0: Node, p1: V, p2: any[]) => void), opt_this?: T): Serializer;
export function makeObjectPropertyPusher<T>(valueReader: ((this: T, p0: Element, p1: any[]) => void), opt_property?: string, opt_this?: T): Parser;
export function makeObjectPropertySetter<T>(valueReader: ((this: T, p0: Element, p1: any[]) => void), opt_property?: string, opt_this?: T): Parser;
...
export function makeSimpleNodeFactory(opt_nodeName?: string, opt_namespaceURI?: string): ((p0: any, p1: any[], p2?: string) => Node);
