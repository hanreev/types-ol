...
const force_include_members = {
  'module:ol/control/FullScreen': ['FullScreenEventType'],
  'module:ol/format/IGC': ['IGCZ'],
  'module:ol/Geolocation': ['GeolocationError'],
  'module:ol/interaction/DragAndDrop': ['DragAndDropEventType'],
  'module:ol/interaction/Draw': ['DrawEventType'],
  'module:ol/interaction/Modify': ['ModifyEventType'],
  'module:ol/interaction/Select': ['SelectEventType'],
