...
exports.handlers = {
  ...
  parseComplete: (/** @type {ParseCompleteEvent} */ e) => {
    ...
    for (let i = doclets.length - 1; i >= 0; --i) {
      ...
      if (doclet.longname == 'module:ol/render/canvas/TextBuilder~TEXT_ALIGN')
        doclet.properties = [
      ...
      if (doclet.longname == 'module:ol/webgl/Buffer~BufferUsage')
        doclet.properties = [
          { name: 'STREAM_DRAW', defaultvalue: '0x88E0', kind: 'member', memberof: doclet.longname },
          { name: 'STATIC_DRAW', defaultvalue: '0x88E4', kind: 'member', memberof: doclet.longname },
          { name: 'DYNAMIC_DRAW', defaultvalue: '0x88E8', kind: 'member', memberof: doclet.longname },
        ];
